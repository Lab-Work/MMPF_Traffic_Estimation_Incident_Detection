...
def left_boundary_statistic(laneNumber, Vmax, inflow):
    lbDensity = (inflow + random.normal(0,150))/Vmax
    lbModel = laneNumber
...
# forward prediction
    ...
    save( directorySave + str(PR)+'lag'+str(lag)+'estDen'+str(inflow)+'PF',estimatedState)
    save( directorySave + str(PR)+'lag'+str(lag)+'estModel'+str(inflow)+'PF',estimatedModel)

    plot_density(estimatedState, savefigure, str(PR)+'lag'+str(lag)+'estDen'+str(inflow)+'PF', directorySave)
    plot_parameter(estimatedModel, savefigure, str(PR)+'lag'+str(lag)+'EstModel'+str(inflow)+'PF', directorySave)
