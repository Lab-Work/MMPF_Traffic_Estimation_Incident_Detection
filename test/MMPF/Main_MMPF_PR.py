...
#                print 'density error is', average(abs(stateError))
            #    print 'model error is', sum(abs(modelError))
                ...
                save( directorySave + str(PR)+'lag'+str(lag)+'R'+str(rand)+'estDen',estimatedState)
                save( directorySave + str(PR)+'lag'+str(lag)+'R'+str(rand)+'estModel',estimatedModel)
...
#                plot_density(densityTrue[0:180], savefigure, 'trueDensityPlot', directorySave)
                plot_density(estimatedState, savefigure, str(PR)+'lag'+str(lag)+'R'+str(rand)+'estDen', directorySave)
                plot_parameter(estimatedModel, savefigure, str(PR)+'lag'+str(lag)+'R'+str(rand)+'estModel', directorySave)
